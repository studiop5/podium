...
OK:
  `<circle cx="12" cy="12" r="9.5" fill="none" stroke="#000" stroke-width="1.2"/>
   <text x="12" y="16.5" text-anchor="middle" style="font-size:12;fill:#000">\u2713</text>`,
...
Range:
  `<text y="17" x="4" font-size="12px" font-family="Bravura">\ue512</text>`,
...
Reload:
  `<path d="M 12.00,10.80 L 12.34,10.72 L 12.72,10.75 L 13.11,10.89 L 13.46,11.16 L 13.75,11.53 L 13.93,12.00 L 13.98,12.53 L 13.88,13.09 L 13.62,13.62 L 13.21,14.09 L 12.66,14.45 L 12.00,14.66 L 11.28,14.69 L 10.55,14.51 L 9.86,14.14 L 9.27,13.57 L 8.84,12.85 L 8.61,12.00 L 8.61,11.09 L 8.85,10.18 L 9.34,9.34 L 10.06,8.64 L 10.97,8.14 L 12.00,7.88 L 13.10,7.90 L 14.18,8.22 L 15.17,8.83 L 15.99,9.70 L 16.57,10.78 L 16.85,12.00 L 16.80,13.29 L 16.41,14.55 L 15.69,15.69 L 14.67,16.62 L 13.41,17.27 L 12.00,17.58 L 10.52,17.51 L 9.09,17.04 L 7.80,16.20 L 6.75,15.03 L 6.02,13.60 L 5.69,12.00 L 5.79,10.34 L 6.32,8.72 L 7.28,7.28 L 8.60,6.11 L 10.21,5.32 L 12.00,4.96 L 13.85,5.08 L 15.64,5.69 L 17.24,6.76 L 18.52,8.24 L 19.39,10.02 L 19.77,12.00 L 19.62,14.04 L 18.94,16.01 L 17.75,17.75 L 16.13,19.15 L 14.17,20.09 L 12.00,20.50" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/><circle cx="12" cy="20.5" r="1.8" fill="currentColor"/>`,
...
Stretcher:
  `<text y="26" x="6.5" font-size="32px" font-family="Bravura">\ue0a1</text>`,
